...
public class CustomItems {
    ...
    public enum Decoration implements ItemStackGetter {
        ...
        GUARD_MASK(new ItemBuilder(Material.BRICK)
                ...
                .build()
        ),PLAYER_CHESTPLATE(new ItemBuilder(Material.LEATHER_CHESTPLATE)
                ...
                .build()
        ),PLAYER_LEGGINGS(new ItemBuilder(Material.LEATHER_LEGGINGS)
                ...
                .build()
        ), PLAYER_BOOTS(new ItemBuilder(Material.LEATHER_BOOTS)
                .name(HexFormatter.hexFormat("&Botas"))
                .setUnbreakable(true)
                .flags(ItemFlag.HIDE_ATTRIBUTES)
                .flags(ItemFlag.HIDE_UNBREAKABLE)
                .addAttributeModifier(Attribute.ARMOR, new AttributeModifier(Attribute.ARMOR.getKey(), 0, AttributeModifier.Operation.MULTIPLY_SCALAR_1, EquipmentSlot.FEET.getGroup()))
                .build()
        ), EMPTY_FOOD(new ItemBuilder(Material.BRICK)
                .setCustomModelData(7)
                .build()
        ),GUARD_HELMET(new ItemBuilder(Material.IRON_HELMET)
                .name(HexFormatter.hexFormat("&bCasco guardia"))
                .setUnbreakable(true)
                .flags(ItemFlag.HIDE_ATTRIBUTES)
                .flags(ItemFlag.HIDE_UNBREAKABLE)
                .addAttributeModifier(Attribute.ARMOR, new AttributeModifier(Attribute.ARMOR.getKey(), 0, AttributeModifier.Operation.MULTIPLY_SCALAR_1, EquipmentSlot.CHEST.getGroup()))
                .build()
        ),GUARD_CHESTPLATE(new ItemBuilder(Material.IRON_CHESTPLATE)
                .name(HexFormatter.hexFormat("&bCamisa guardia"))
                .setUnbreakable(true)
                .flags(ItemFlag.HIDE_ATTRIBUTES)
                .flags(ItemFlag.HIDE_UNBREAKABLE)
                .addAttributeModifier(Attribute.ARMOR, new AttributeModifier(Attribute.ARMOR.getKey(), 0, AttributeModifier.Operation.MULTIPLY_SCALAR_1, EquipmentSlot.CHEST.getGroup()))
                .build()
        ),GUARD_LEGGINGS(new ItemBuilder(Material.IRON_LEGGINGS)
                .name(HexFormatter.hexFormat("&bPantalón guardia"))
                .setUnbreakable(true)
                .flags(ItemFlag.HIDE_ATTRIBUTES)
                .flags(ItemFlag.HIDE_UNBREAKABLE)
                .addAttributeModifier(Attribute.ARMOR, new AttributeModifier(Attribute.ARMOR.getKey(), 0, AttributeModifier.Operation.MULTIPLY_SCALAR_1, EquipmentSlot.LEGS.getGroup()))
                .build()
        ), GUARD_BOOTS(new ItemBuilder(Material.IRON_BOOTS)
                .name(HexFormatter.hexFormat("&Botas"))
                .setUnbreakable(true)
                .flags(ItemFlag.HIDE_ATTRIBUTES)
                .flags(ItemFlag.HIDE_UNBREAKABLE)
